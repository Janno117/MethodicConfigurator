...
We used a [Series 1780 test stand](https://www.tytorobotics.com/pages/series-1780) (discontinued) from Tyto Robotics (was RCBenchmark) to test the motors. Since the test stand was too big for a single motor we tested all four motors at once. This was our setup:

- Series 1780 test stand from Tyto Robotics
- Delta Elektronika "SM66-AR-110" power supply
- T-Motor F1507 3800kv motors
- Mamba Systems F45_128k BLHeli32 4in1 ESC
- HQProp "DUCT-76MMX8" propellers

![test stand with drone](test stand with drone see folder images)

We fixed and updated Cell G8 as well as the plot's Data range of the [original ArduPilot Wiki Spreadsheet](https://docs.google.com/spreadsheets/d/1_75aZqiT_K1CdduhUe4-DjRgx3Alun4p8V2pt6vM5P8/edit#gid=0) creating [this corrected version](https://docs.google.com/spreadsheets/d/1yoLG3nnOZo_0jXBSKt9SPyS8Z8qpcXZ70Y_To4LiEus/edit?usp=sharing)
We imported the data into the spreadsheet and created this graph:

![thrust vs PWM](graph from spreadsheet see folder images)
